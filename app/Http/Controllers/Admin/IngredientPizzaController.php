...
class IngredientPizzaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.ingredients_pizzas.index', compact('pizzas'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('administrations/ingredients_pizzas/')->with('message', 'Relaciones ingredientes y pizza actualizado');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('administrations/ingredients_pizzas/')->with('message', 'Relaciones ingredientes y pizza eliminados');
