...
class PizzaController extends Controller {
    ...
    public function store(Request $request)
    {
        $this->validate(
            ...
            [
                ...
                'description.required' => 'La descripcion de la pizza es requerida',
            ]
        );
        $user_id = auth()->user()->id;
        $arr_user_id = compact('user_id');
        Pizza::create(array_merge($request->input(), $arr_user_id));
    ...
    public function update(Request $request, $id)
    {
        ...
        $pizza = Pizza::find($id);
        $pizza->fill(array_merge($request->all(), $arr_user_id))->save();
